...
export default function SignUpForm() {
    ...
    const onSubmit = async (data: SignUpFormValues) => {
        ...
        try {
            ...
            // Redirect or automatically sign in user here
        } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden font-sans antialiased">
            ...
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-emerald-600/20 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute bottom-10 left-10 w-80 h-80 bg-teal-500/10 rounded-full blur-2xl pointer-events-none" />

            {/* Card Wrapper */}
            <div className="w-full max-w-lg bg-slate-800/80 border border-slate-700/80 rounded-3xl p-8 shadow-2xl backdrop-blur-md relative z-10 space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-slate-400">
                        Join us to explore and book your next trip in Laos
                    </p>
                </div>
                    ...
                    <div className="space-y-1 pt-1">
                        <label className="flex items-start gap-2.5 cursor-pointer select-none">
                            <input
                                ...
                                className="w-4 h-4 mt-0.5 rounded border-slate-700 bg-slate-900 text-emerald-600 focus:ring-emerald-500/20 focus:ring-offset-slate-800 shrink-0"
                            />
                            <span className="text-xs text-slate-400 leading-normal">
                                I agree to the{" "}
                                <Link href="/terms" className="text-emerald-400 hover:underline font-semibold">
                                    Terms of Service
                                </Link>{" "}
                                and{" "}
